...
var Canvas = function () {
    function Canvas(ctx, w, h) {
        ...
        this.scene = new _scene2.default(ctx, w, h);
        this.lastDraw = null;
    }
...
exports.ScrollAnimationLoop = exports.TriggerCollection = exports.Trigger = undefined;
...
var _TriggerCollection2 = __webpack_require__(10);

var _TriggerCollection3 = _interopRequireDefault(_TriggerCollection2);

var _ScrollAnimationLoop2 = __webpack_require__(9);

var _ScrollAnimationLoop3 = _interopRequireDefault(_ScrollAnimationLoop2);
...
var Trigger = exports.Trigger = _Trigger3.default;
var TriggerCollection = exports.TriggerCollection = _TriggerCollection3.default;
var ScrollAnimationLoop = exports.ScrollAnimationLoop = _ScrollAnimationLoop3.default;
  ...
  */
   ...
   */
		...
		value: function createTrigger(element, options) {
			return new Trigger(element, (0, _objectExtend2.default)(this.defaultTrigger, options));
		}
...
var _ScrollTrigger = __webpack_require__(5);
...
(function (document, window) {
    ...
    var canvas = new _canvas2.default(ctx, w, h);
    ...
    _createClass(Scene, [{
        ...
        value: function populate() {
            ...
            for (var i = 0; i < amount; i++) {
                var point = new _point2.default(i, this.width, this.height);
            ...
            for (var x = 0; x < this.points.length; x++) {
                ...
                for (var y = 0; y < this.points.length; y++) {
                    ...
                    if (distance <= CONNECT_DISTANCE * (1 - this.scrollDelta)) {
                        var tag = point.id > reference.id ? reference.id + '_' + point.id : point.id + '_' + reference.id;
	...
	_createClass(ScrollAnimationLoop, [{
		...
		value: function _parseOptions(options) {
			...
			if (typeof options != 'function') {
				...
				defaults = (0, _objectExtend2.default)(defaults, options);
			} else {
...
//# sourceMappingURL=ScrollTrigger.js.map?9962c91f0379832d415b